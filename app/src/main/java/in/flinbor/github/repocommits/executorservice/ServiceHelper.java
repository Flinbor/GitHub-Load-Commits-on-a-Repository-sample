...
package in.flinbor.github.repocommits.executorservice;
...
import in.flinbor.github.repocommits.executorservice.command.BaseCommand;
...
public class ServiceHelper {
    ...
    public int getRepositories(String username) {
        ...
        Intent i = createIntent(application, new GetRepositoryCommand(username), requestId);
